...
import 'font-awesome/css/font-awesome.min.css'; // Nếu sử dụng Font Awesome
                        ...
                        <div className="row g-0">
                            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.1s" style={{ minHeight: '400px' }}>
                                <div className="position-relative h-100">
                                    <img className="position-absolute w-100 h-100 rounded" src="img/call-to-action.jpg" style={{ objectFit: 'cover' }} alt="Call to Action" />
                                </div>
                            </div>
                        ...
                        {Array.from({ length: 3 }).map((_, index) => (
                            <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay={`${0.1 + index * 0.2}s`} key={index}>
                                <div className="team-item position-relative">
                                    <img className="img-fluid rounded-circle w-75" src={`img/team-${index + 1}.jpg`} alt={`Team Member ${index + 1}`} />
